...
const About: NextPage = () => {
    return (
        <div className="root_container" style={{fontSize: "large"}}>
            ...
            <Paragraph>
                I'm not too sure what to put here, but here we go.
                Hi, I'm Vaskel. I'm a bisexual high schooler from the US, I play video games and program. I know, so interesting.
                The best place to contact me is on discord.
                <br/>
            ...
            <Paragraph>These are my most proficient languages ranked from highest to lowest.</Paragraph>
            <Paragraph>Python: This is my first language and my most liked one.</Paragraph>
